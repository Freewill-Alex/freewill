...
public class CustomBeetlTemplateConfig {
    /**
     * 模板根目录 ，比如 "templates"
     */
    ...
    public BeetlGroupUtilConfiguration getBeetlGroupUtilConfiguration() {
        ...
        try {
            ...
            ClasspathResourceLoader cploder = new ClasspathResourceLoader(CustomBeetlTemplateConfig.class.getClassLoader(), this.templatesPath);
