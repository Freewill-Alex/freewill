...
import com.freewill.common.util.RequestContextHolderUtil;
...
import static com.freewill.common.web.wrapper.CommonConstant.SUCCESS;
...
public class ResponseResultAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType, Class<? extends HttpMessageConverter<?>> selectedConverterType, ServerHttpRequest request, ServerHttpResponse response) {
        ...
        if (resultClazz.isAssignableFrom(GlobalResponseResult.class)) {
            GlobalResponseResult result = new GlobalResponseResult().setStatus(SUCCESS).setMessage("").setPath(RequestContextHolderUtil.getRequest().getRequestURI()).setData(body);
