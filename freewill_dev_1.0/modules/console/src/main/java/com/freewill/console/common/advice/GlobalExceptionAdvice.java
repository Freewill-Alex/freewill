...
import static com.freewill.common.web.wrapper.CommonConstant.ERROR;
...
public class GlobalExceptionAdvice {
    ...
    public GlobalResponseResult businessException(HttpServletRequest req, BussinessException e) {
        log.debug("API服务异常：", e);
        return new GlobalResponseResult().setStatus(ERROR).setMessage(BUSINESS_ERR).setPath(req.getRequestURI()).setData("Exception ：" + e.getMessage());
    ...
    public GlobalResponseResult handleMethodArgumentNotValidException(HttpServletRequest req, MethodArgumentNotValidException e) {
        ...
        return new GlobalResponseResult().setStatus(ERROR).setMessage(BUSINESS_ERR).setPath(req.getRequestURI()).setData("参数验证失败" + message);
    }
    ...
    public GlobalResponseResult handleBindException(HttpServletRequest req, BindException e) {
        ...
        return new GlobalResponseResult().setStatus(ERROR).setMessage(BUSINESS_ERR).setPath(req.getRequestURI()).setData("参数绑定失败" + message);
    }
