...
public final class CommonConfig {
    ...
    /**
     * @param smsOff the smsOff to set
     */
    ...
    /**
     * @param redisServer the redisServer to set
     */
    ...
    /**
     * @param aliyunRamAccesskey the aliyunRamAccesskey to set
     */
    ...
    /**
     * @param aliyunRamAccesssecret the aliyunRamAccesssecret to set
     */
    ...
    /**
     * @param aliyunSmsSign the aliyunSmsSign to set
     */
